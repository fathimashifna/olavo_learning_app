...
public class LiveResultActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
     ...
     getWindow().setFlags(WindowManager.LayoutParams.FLAG_SECURE, WindowManager.LayoutParams.FLAG_SECURE);
        ...
        {
            startActivity(new Intent(LiveResultActivity.this, NoNetworkActivity.class));
            finish();
        }
    }
    @Override
    public void onBackPressed() {
        ...
        Intent intent=new Intent(LiveResultActivity.this, NavigationActivity.class);
    ...
    public void getrslt(final String user_id, final String device_id, final String exm_id) {
        ...
        String url1 = BaseClass.mainURL + "live_exam_score";
//Log.e("url",""+url1);
        final ProgressDialog progress = new ProgressDialog(LiveResultActivity.this);

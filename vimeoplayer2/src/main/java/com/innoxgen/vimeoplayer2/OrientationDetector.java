...
public class OrientationDetector {
    ...
    private int currentOrientation = ActivityInfo.SCREEN_ORIENTATION_PORTRAIT;//Initially in portrait
    ...
    The direction changes, start timing, the current direction is%s", currDirection));
                            }*/
                        } else {
                            calcHoldingTime();

...
public class ExamActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (isNetworkConnectionAvailable()) {
            ...
            startActivity(new Intent(ExamActivity.this, NoNetworkActivity.class));
            finish();
        }
    ...
    public void getexmList(final String user_id, final String device_id, final String exm_id) {
        ...
        String url1 = BaseClass.mainURL + "get_questions";
//Log.e("url",""+url1);
        final ProgressDialog progress = new ProgressDialog(ExamActivity.this);
                        ...
                        try {
                            ...
                            if (status.equals("true")) {
                                for (int i = 0; i < jsonArray.length(); i++) {
                                    ...
                                    ExamModel examModel = new ExamModel(qstn_id, questions, optionA, optionB, optionC, optionD, correct_ans, explanation, explanation);
    ...
    public void submitexm(final String user_id, final String device_id, final String exm_id, final String time_taken, final String json) {
        ...
        String url1 = BaseClass.mainURL + "submit_exam";
//Log.e("url",""+url1);
        final ProgressDialog progress = new ProgressDialog(ExamActivity.this);
        progress.setMessage("Loading...");
        progress.setCancelable(false); // disable dismiss by tapping outside of the dialog
